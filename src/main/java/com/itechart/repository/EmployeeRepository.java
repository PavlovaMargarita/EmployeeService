...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("update Employee e set e.f_name=:f_name, e.s_name=:s_name, e.dateOfBirth=:dateOfBirth,e.sex=:sex, e.country=:country," +
            ...
            "e.department=:department, e.positionInCompany=:positionInCompany, e.dateContractEnd=:dateContractEnd," +
            "e.fired=:fired, e.firedComment=:firedComment  where e.id =:id")
    public int updateEmployee(@Param("id") Long id, @Param("f_name") String f_name, @Param("s_name") String s_name, @Param("dateOfBirth") Date dateOfBirth,
                              ...
                              @Param("dateContractEnd") Date dateContractEnd, @Param("fired") Boolean fired, @Param("firedComment") String firedComment);


    @Query("select e from Employee e where e.fired = false order by e.dateContractEnd")
